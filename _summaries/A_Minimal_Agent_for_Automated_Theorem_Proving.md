...
af_tools: [lean4_mcp, theorem_search, literature_search]
...
af_tool_notes:
  ...
  theorem_search: "The Library Search tool provides the agent with a custom deployment of LeanSearch to help identify and retrieve necessary mathematical premises. It utilizes vector embeddings to search through Mathlib, Lean's formal mathematical library, allowing the agent to find specific lemmas, theorems, or tactics required to build its proof."
  literature_search: "The Library Search tool provides the agent with a custom deployment of LeanSearch to help identify and retrieve necessary mathematical premises. It utilizes vector embeddings to search through Mathlib, Lean's formal mathematical library, allowing the agent to find specific lemmas, theorems, or tactics required to build its proof."
af_agent_notes:
